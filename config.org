...
(unless (boundp 'org-roam-directory)
  ...
  (add-to-list 'org-agenda-files org-roam-directory 'append)
  (add-to-list 'org-agenda-files (concat (file-name-as-directory
                                          org-roam-directory) "journal") 'append)
  (let* ((default-directory org-roam-directory))
    (add-dir-local-variable nil org-roam-directory org-roam-directory)))

;; (setq org-roam-date-filename-format "journal/%Y-%m-%d")
...
#+END_SRC
*** org-journal
A souped-up journal, possibly preferable to `org-roam-today` (at least, the
org-roam docs say that).

#+begin_src emacs-lisp :tangle yes
;; (if (featurep! :lang org +journal))
;; (after! org-journal
...
(add-to-list 'jm/org-capture-templates
             `("d" "Daily" entry (file+datetree ,(concat (file-name-as-directory org-directory) "diary.org"))
...
(add-to-list 'jm/org-capture-templates
             `("m" "Meeting" entry (file+datetree ,(concat (file-name-as-directory org-directory) "diary.org"))
